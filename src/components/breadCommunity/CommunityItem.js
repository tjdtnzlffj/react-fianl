		...
		<div className={classes.breadcontainer}>
			...
			>
				...
				<div className={classes.imgContainer} onClick={() => {
					...
					dispatch({ type: "OPEN_MODAL", payload: { modalState: true, renderingComponent: <CommunityDetail /> } });
				}} >
					<img src={board.postImage} alt="bread" style={{ width: "100%", height: "100%", objectFit: "contain", }} />
				</div>
